...
function Question(props: Question) {
  ...
  return (
   <p className='flex md:max-w-xs font-mono xl:max-w-lg 2xl:max-w-xl relative xl:p-4 2xl:px-8  2xl:pt-4 2xl:pb-8 bg-slate-800 p-2 md:p-4 rounded-xl flex-col gap-2'>
